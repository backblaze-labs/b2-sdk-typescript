...
describe('B2Object.createWriteStream', () => {
  ...
  it(
    'merges multiple buffered chunks into a single final part at close',
    async () => {
  ...
  it(
    'closes cleanly when total bytes are an exact partSize multiple (no remainder)',
    async () => {
  ...
  it(
    'clamps a too-small partSize up to the account minimum and still round-trips',
    async () => {
  ...
  it(
    'rejects done and cancels the unfinished large file when b2_upload_part fails',
    async () => {
  ...
  it(
    'abort after parts have started cancels the unfinished large file',
    async () => {
  ...
  it(
    'honors a slow-consumer pipeTo (backpressure via concurrency=1) and round-trips bytes',
    async () => {
  ...
  it(
    'passes serverSideEncryption through to startLargeFile and each part upload',
    async () => {
  ...
  it(
    'swallows cancelLargeFile failures during close-path cleanup',
    async () => {
  ...
  it(
    'swallows cancelLargeFile failures during the abort hook',
    async () => {
  ...
  it(
    'close() rethrows the errored latch and cancels the unfinished large file',
    async () => {
