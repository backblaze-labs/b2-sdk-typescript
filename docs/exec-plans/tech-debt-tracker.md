...
| 2 | **Native API doc drift** — B2 docs and live behavior disagree in places. | Mitigated | Guardrails in [design-doc 0002](../design-docs/0002-native-api-docs-drift-guardrails.md); upstream handoff tracked in [#108](https://github.com/backblaze-labs/b2-sdk-typescript/issues/108). |
